...
def main():
    ...
    # Path options.
    parser.add_argument("--corpus_path", default='corpora/encrypted_traffic_burst.txt', type=str,
                        help="Path of the corpus for pretraining.")
    parser.add_argument("--vocab_path", default='models/encryptd_vocab.txt', type=str,
    ...
    # Masking options.
    parser.add_argument("--dynamic_masking", action="store_true", help="Dynamic masking.", default=True)
